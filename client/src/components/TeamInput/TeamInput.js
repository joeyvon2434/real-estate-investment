            ...
            <div>
                <form id="team-form">
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control short-field" name="name" placeholder={this.props.name} onChange={this.props.handleInputChange} />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control short-field" name="picture" placeholder={this.props.picture} onChange={this.props.handleInputChange} />
                    </div>
